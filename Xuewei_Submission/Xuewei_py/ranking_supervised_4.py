...
@author: haikundu
"""
#Must run "supervised_learning.py" before this script

import pandas as pd

whole_page_sent = pd.read_csv('/Users/duxuewei/Desktop/projectds/project/ranking_whole_new.csv')

#merge all tweets
thePath = '/Users/duxuewei/Desktop/projectds/project/'
whole_page = pd.read_csv('/Users/duxuewei/Desktop/projectds/project/10_13.csv',sep=';',error_bad_lines = False)
...
#Must run "supervised_prediction.py" after this script