...
retweett = [retweets_13, retweets_14, retweets_15, retweets_16, retweets_17, retweets_18, retweets_19,
            retweets_20, retweets_21, retweets_22, retweets_23, retweets_24]
...
model = sm.OLS(Daily_gross_1, Aver_sent)
...
model = sm.OLS(Use, Daily_gross_2)
results = model.fit()
print(results.summary())
